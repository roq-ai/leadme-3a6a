  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Leadme - Your ultimate directory of lead form generators. Over 1000 forms to fulfill, connecting your requests to a vast network of suppliers."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsZWFkJTIwZ2VuZXJhdGlvbnxlbnwwfHx8fDE2OTE5MTUzMzh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Leadme - Your ultimate directory of lead form generators. Over 1000 forms to fulfill, connecting your requests to a vast network of suppliers.`}
            </Text>
            <Box
